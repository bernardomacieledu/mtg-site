# Generated by Django 5.0.14 on 2026-04-02 01:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Minha Coleção', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cards_json', models.JSONField(default=list)),
                ('categorized_json', models.JSONField(default=dict)),
                ('commander_json', models.JSONField(blank=True, null=True)),
